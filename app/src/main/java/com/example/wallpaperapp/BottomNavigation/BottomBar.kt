...
fun BottomBar(navController: NavHostController, state: MutableState<Boolean>, modifier: Modifier = Modifier){
    val screens= listOf(BottomNavigationScreens.wallpapers,BottomNavigationScreens.category,BottomNavigationScreens.favourite,BottomNavigationScreens.profile)
